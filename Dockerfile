...
CMD pip install --no-cache-dir notebook; pip install --no-cache-dir -r /tmp/requirements.txt && \
    ...
    voila --no-browser --port=8866 --Voila.ip=0.0.0.0 --template=materialscloud-tool /sajex/SAJEx.ipynb
